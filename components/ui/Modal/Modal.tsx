      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto h-full">
          <div className="flex min-h-full overflow-hidden items-center justify-center p-2">
            ...
            >
              <Dialog.Panel className="relative w-full max-w-3xl h-full overflow-visible transform text-left align-middle shadow-3xl mb-[60px] transition-all rounded-xl bg-base p-6 md:p-8">
